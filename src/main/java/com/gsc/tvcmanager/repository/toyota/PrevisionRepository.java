...
public interface PrevisionRepository extends JpaRepository<TVCUsedCarsPrevisionSales, Integer>, PrevisionRepositoryCustom {
    ...
    List<TVCUsedCarsPrevisionSales> previsionMonthly(@Param("year") Integer year,@Param("month") Integer month, @Param("reportType") String reportType, @Param("previsionType") String previsionType);
    ...
    List<TVCUsedCarsPrevisionSales> previsionExcell(@Param("year") Integer year,@Param("month") Integer month, @Param("reportType") String reportType, @Param("previsionType") String previsionType);
}
